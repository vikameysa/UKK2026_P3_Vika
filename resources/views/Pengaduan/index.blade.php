        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="GET" class="row g-3 mb-4">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <a href="{{ route('Pengaduan.pengaduan') }}" class="btn btn-secondary w-100">Reset</a>
                    </div>
                </form>
                                ...
                                32
                                    <td colspan="9" class="text-center">
                                        <div class="py-4">
                                            ...
                                            <a href="{{ route('Pengaduan.history') }}" class="btn btn-sm btn-success">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('Pengaduan.destroy', $a->id_aspirasi) }}" method="POST">
                    @csrf
                    @method('DELETE')

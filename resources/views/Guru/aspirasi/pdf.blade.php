...
<head>
    <meta charset="UTF-8">
    <title>History Aspirasi Selesai - Guru</title>
    <style>
...
<body>
    ...
    <div class="no-print">
        <a href="{{ route('guru.aspirasi.history') }}" class="btn-back">&#8592; Kembali</a>
    ...
    <div class="info-box">
        <table>
            <tr><td>Nama Guru</td><td>:</td><td>{{ $guru->nama }}</td></tr>
            <tr><td>Jabatan</td><td>:</td><td>{{ $guru->jabatan }}</td></tr>
    ...
    <table class="main">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->user->siswa->nama ?? $item->user->guru->nama ?? $item->user->name }}</td>
            ...
            @empty
            <tr>
                <td colspan="8" style="text-align:center; padding:16px; color:#999;">Tidak ada data.</td>
            </tr>
            @endforelse
        </tbody>
    </table>

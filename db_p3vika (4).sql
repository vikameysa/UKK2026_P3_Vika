...
--
-- Host: localhost:3306
-- Generation Time: Apr 18, 2026 at 04:48 PM
...
(7, 3, 1, 'Lab Komputer 1 (LAB-01)', 'zxchjkllkjhv', 'aspirasi_foto/t5RP68Org6hJuMpKKZ4JUQDgATsTOex36UzsMCAS.png', 'Selesai', '2026-04-15 01:15:31', '2026-04-18 09:43:44', 4),
(8, 3, 5, 'Perpustakaan (PUSTAKA)', 'asdcfgvbhj', 'aspirasi_foto/m23e7oDDCDiSEsmR3i58sjh1vPR6mO2aw79c2XMX.png', 'Selesai', '2026-04-15 01:54:12', '2026-04-18 09:01:58', 6),
(9, 4, 2, 'Kantin Sekolah (KANTIN)', 'jhxzxcvbn', 'aspirasi_foto/vBjaxZG7vhHqrVpg9FSWTtCkmRyP5jOhkmVhDOve.png', 'Selesai', '2026-04-15 01:54:57', '2026-04-15 19:18:02', 7),
(10, 4, 2, 'Kantin Sekolah (KANTIN)', 'iuyfghj', 'aspirasi_foto/y0QdopGmu3wEg6R1n2F07p5Nr27J7Q6cLeXH4wqI.png', 'Selesai', '2026-04-15 20:29:33', '2026-04-18 05:03:22', 7);
...
(3, 7, '2222222222222', 'guru', 'bhs', 'Guru', 'P', '2026-04-03', 'kjhgfghjk', '098765432', 'assets/images/guru/1776306911_kelola data.drawio.png', '2026-04-15 19:35:11', '2026-04-15 19:35:11'),
(4, 10, '23456789', 'guru2', 'indonesia', 'Guru', 'P', '2026-04-01', 'iuyfdssdfghjk', '098765432', 'assets/images/guru/1776322894_usecase admin (2).png', '2026-04-16 00:01:34', '2026-04-16 00:01:34');
...
(6, 9, 'Menunggu', 'Selesai', 2, '2026-04-15 19:18:02'),
(7, 10, 'Menunggu', 'Selesai', 5, '2026-04-18 05:03:22'),
(8, 8, 'Menunggu', 'Selesai', 5, '2026-04-18 09:01:58'),
(9, 7, 'Menunggu', 'Selesai', 2, '2026-04-18 09:43:44');
...
(2, 8, '22110000', 'hgfcvbnm', 'P', '2026-04-11', 'kjhgfdfghj', '9987765447333', 'assets/images/petugas/1776307117_add.png', 'Aktif', '2026-04-15 19:38:38', '2026-04-15 19:38:38');
...
(8, 9, 2, 'Feedback: hjklkj,', '2026-04-15 19:14:23'),
(9, 9, 2, 'Feedback: kjhgvbnm', '2026-04-15 19:16:51'),
(10, 9, 2, 'kjhgfghjkl', '2026-04-15 19:16:59'),
(11, 9, 2, 'kjbn m,lk\n📎 http://127.0.0.1:8000/storage/aspirasi_bukti/nNZMza7fOgkztbPaagu7GsO8Wg61n98gfnftUz9p.png', '2026-04-15 19:18:02'),
(12, 8, 3, 'Feedback dari siswa: jhgfghjklkjh', '2026-04-16 00:39:36'),
(13, 8, 5, 'Feedback: kjhgcv', '2026-04-18 09:00:07'),
(14, 7, 2, 'Feedback: kjhgf', '2026-04-18 09:43:35');
...
(2, 9, '3333333333', 'siswa', '10', 'jb', 'P', '2026-04-14', 'kjhgfdsasdfghmnbv', '0987654', 'assets/images/siswa/1776308205_Vika Meysa-.jpg', '2026-04-15 19:56:45', '2026-04-15 19:56:45', NULL, NULL);
...
(3, 'guru1@ukk2026.com', '$2y$12$eq2s4YtD0zf1VhKRDMEOpeiVwVD3TbAFJNSTq6J/EGWRZc2wWyHQq', 'guru', '2026-04-06 23:01:42', '2026-04-15 17:39:55'),
...
(7, 'guru3@ukk2026.com', '$2y$12$jiKBNXYHsJayJgfUT5iHjOz.kpRKz66sJqNdc2V8fPGeT4RYHPCsC', 'guru', '2026-04-15 19:35:11', '2026-04-15 19:35:11'),
(8, 'petugas22@ukk2026.com', '$2y$12$Z2x.aFwfUeMbdktbSbbsqOppmwMPk7N3i/pJOrRVQ3iSFImydCqgG', 'petugas', '2026-04-15 19:38:38', '2026-04-15 19:38:38'),
(9, 'siswa3@ukk2026.com', '$2y$12$d1WOKuZEvjv1wr60UavMBuv1W6DdSsjGo7vTFKprk3ECEeRsMSm56', 'siswa', '2026-04-15 19:56:44', '2026-04-15 19:56:44'),
(10, 'guru2@ukk2026.com', '$2y$12$qvjQQDmxoPMt3a7QgftNdOmtp81a2OhVRCbhfuHmaVEDNtp4QIdPy', 'guru', '2026-04-16 00:01:34', '2026-04-16 00:01:34');
...
--
ALTER TABLE `history_status`
  MODIFY `id_history` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `progres`
  MODIFY `id_progres` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
